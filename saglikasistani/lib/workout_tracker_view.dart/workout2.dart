...
class Workout2 extends StatefulWidget {
  final Map dObj;
  var userResult;
  Workout2({super.key, required this.dObj, required this.userResult});
  
  @override
  State<Workout2> createState() => _WorkoutDetailViewState();
}

class _WorkoutDetailViewState extends State<Workout2> {
  List latestArr = [
    {
        ...
        headerSliverBuilder: (context, innerBoxIsScrolled) {
          return [
            SliverAppBar(
              ...
              leading: InkWell(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) =>  WorkoutTrackerView(widget.userResult)));
                },
                child: Container(
            ...
            SliverAppBar(
              ...
              leadingWidth: 0,
              leading: Container(),
              expandedHeight: media.width * 0.33,
              flexibleSpace: Align(
                alignment: Alignment.center,
                child: Image.asset(
                  widget.dObj["image"],
              ...
              children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      IconTitleNextRow(
                          ...
                          onPressed: () {
                            Navigator.push(context, MaterialPageRoute(builder: (context) => WorkoutDetailView(dObj: widget.dObj, userResult: widget.userResult,) )  );
                          }, timeOptions: [],),
                      SizedBox(
                        height: media.width * 0.05,
                      ),
                ...
                SafeArea(
                  child: Column(
                    ...
                    children: [
                      RoundButton(title: "Çalışmaya Başla!", onPressed: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ExercisesStepDetails(dObj: widget.dObj,),
                                  ),
                                );
                              },),
                              SizedBox(
